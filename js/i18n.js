window.DARMON_I18N = {
  ru: {
      ...
      nav_home:"Главная", nav_about:"O нас", nav_specialists:"Специалисты", nav_doctors:"Врачи", nav_results:"Результаты", nav_contact:"Контакты", nav_vacancies:"Вакансии", nav_emergency:"Скорая",
      fab_call:"Позвонить",
      ...
      vac_badge:"Вакансии", vac_title:"Присоединяйтесь к команде", vac_sub:"Открытые вакансии.",
  ...
  uz: {
      ...
      vac_badge:"Vakansiyalar", vac_title:"Jamoamizga qo'shiling", vac_sub:"Ochiq ish o'rinlari.",
  ...
  en: {
        ...
        vac_badge:"Vacancies", vac_title:"Join our team", vac_sub:"Below are currently open positions.",
        res_badge:"Lab results & booking", res_title:"Results, quick status, and appointments", res_sub:"Login/Registration to download PDFs and book appointments. Use quickcheck to check the status of your result.",
